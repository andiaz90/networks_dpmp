...
PV r_star Rworld pi_e Bstar Pipstar Q TB PX X Ystar V PVstar GDP IMP mkupV CFs CFg X_cu
...
rho_pc sigma_pc Pcstar_ss shock_eps_pc Y2_ss X_cu_ss
...
TB = PX*X - chiX_2*X*PX + PH_2*X_cu - PO*VOil - PV*(VNon+CFs+CFg);
TB_f = PX_f*X_f - chiX_2*X_f*PX_f + PH_f_2*X_cu_f - PO_f*VOil_f - PV_f*(VNon_f+CFs_f+CFg_f);
