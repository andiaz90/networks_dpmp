...
\midrule
PIB & -0.439 & -0.439 & 1 \\
Inflación IPC & +0.001 & +0.119 & 2 \\
Consumo & -0.199 & -0.216 & 3 \\
Empleo & +0.173 & +0.173 & 1 \\
Tipo de Cambio Real & -0.191 & -0.226 & 3 \\
Balanza Comercial & -0.244 & -0.244 & 1 \\
Tasa de Política & +0.000 & +0.140 & 5 \\
\bottomrule
\end{tabular}
