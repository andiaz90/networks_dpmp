...
ctx = (
    ...
    title_long = "Shock de Productividad en Minería (-10%)", title_short = "Shock PTF Minería",
    ...
    decomp_caption = "Descomposición Sectorial de un Shock Negativo de 10\\% a la PTF en Minería",
    ...
    agg_caption = "Respuestas Agregadas a un Shock Negativo de 10\\% a la PTF en Minería",
    agg_notes = "PIB, consumo, empleo y TCR en \\% de desviación del estado estacionario; inflación y tasa de política en pp anualizados; balanza comercial en pp del PIB. El shock es una reducción única de 10\\% en la productividad total de factores del sector Minería con persistencia \$\\rho = $(round(rho_tfp1_val,digits=3))\$. Impacto = respuesta en el trimestre 1. Mín/Máx = respuesta extrema en 40 trimestres.",
    get_irf = get_irf_var,
)
