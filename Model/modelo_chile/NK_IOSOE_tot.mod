...
//% Terms of Trade shock version: PVstar follows AR(1) process
...
IMP_ss rho_pvstar sigma_pvstar
...
//% Terms of Trade Shock: PVstar follows AR(1) process
//% A positive eps_pvstar shock increases the price of imports (worsens ToT for the SOE)
...
// Shocks: activated from workspace values written by multi_model_comparison.m
shocks;
var eps_pvstar = shock_eps_pvstar_val;
var eps_om = shock_eps_om_val;
var eps_i = shock_eps_i_val;
var epschi = shock_epschi_val;
@#for z in 1:nsec
